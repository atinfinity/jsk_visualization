...
| ImageView2Plugin | widget renders; image/topic selection is a GUI action, and the marked-image round trip needs the (unported) image_view2 node | rendered (idle) |
